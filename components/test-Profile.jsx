...
const test-Profile = () => {
  ...
  console.log(user) // see user info here
  if(user) {
  return (
      ...
      <div class="bg-white rounded overflow-hidden shadow-lg">
        <div class="text-center p-6  border-b">
          <img
            ...
            alt="Randy Robertson"
          />
          <p class="pt-2 text-lg font-semibold">UID >> {user.uid}</p>
    ...
    return (
      ...
      <div className="flex flex-col items-center mt-20">
        <div
          class=" w-40 h-40 border-4 border-green border-dashed rounded-full animate-spin">
        </div>
        <div>
