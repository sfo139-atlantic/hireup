...
const Navbar = () => {
  return (
    <Disclosure as="nav" className="fixed top-0 left-0 right-0 bg-transparent">
      {({ open }) => (
        <>
          <div className="max-w-7xl mx-auto px-2 sm:px-6 lg:px-8">
            <div className="relative flex items-center justify-between h-16">
              ...
              <div className="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
                ...
                <a key="Join" href="#" className="px-3 py-2 rounded-xl text-lg font-medium text-green border border-green hover:text-white hover:bg-green">Join</a>
                {/* Profile dropdown */}
            ...
            <div className="px-2 pt-2 pb-3 space-y-1">
              {navigation.map((item) => (
                <Disclosure.Button
                  ...
                  href={item.href}
                  className={classNames(
                    item.current ? 'bg-green text-black' : 'text-white hover:bg-green hover:text-black',
